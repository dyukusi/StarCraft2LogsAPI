...
import starcraft2logsapi.rest.HelloResourceRouter;

@Machine
public class HelloResourceRouterFactoryMachine extends SingleNameFactoryMachine<starcraft2logsapi.rest.HelloResourceRouter> {
    public static final Name<starcraft2logsapi.rest.HelloResourceRouter> NAME = Name.of(starcraft2logsapi.rest.HelloResourceRouter.class, "HelloResourceRouter");

    public HelloResourceRouterFactoryMachine() {
        super(0, new StdMachineEngine<starcraft2logsapi.rest.HelloResourceRouter>(NAME, 0, BoundlessComponentBox.FACTORY) {
private final Factory.Query<starcraft2logsapi.rest.HelloResource> resource = Factory.Query.byClass(starcraft2logsapi.rest.HelloResource.class).mandatory();
...
paramMapperRegistry
            ...
            @Override
            protected starcraft2logsapi.rest.HelloResourceRouter doNewComponent(SatisfiedBOM satisfiedBOM) {
